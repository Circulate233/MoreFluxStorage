...
public class TileFluxAccessorFlux extends AENetworkBlockEntity implements IFluxProxyHost, ProxyFluxDevice.Host {
    ...
    @Override
    public void loadTag(@NotNull CompoundTag tag) {
        getOrCreateFluxProxyDevice().setLevel();
        super.loadTag(tag);
    ...
    private @Nullable IStorageService getStorageService() {
        ...
        return getGridNode().getGrid() == null ? null : getGridNode().getGrid().getStorageService();
    }
